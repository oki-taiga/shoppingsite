...
<p class="error_message">ログインが完了しました。<br>
<a class="link" href="<%= request.getContextPath() + "/Preview.action" %>">購入はこちらから</a><br>
<a class="link" href="<%= request.getContextPath() + "/views/home.jsp" %>">サイトのトップ画面へ</a></p>
</main>
<footer id="footer">
