...
<p class="error_message">会員登録が完了しました。<br>
会員番号：${memberid}<br>
<a class="link" href="<%= request.getContextPath() + "/views/login.jsp" %>">ログインはこちらから</a><br>
<a class="link" href="<%= request.getContextPath() + "/views/regist.jsp" %>">サイトのトップ画面へ</a></p>
</main>
<footer id="footer">
